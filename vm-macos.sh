...
download_vm_image() {
    ...
    VM_SUPPORT_IMAGE_INFO="$(curl --silent -m 10 --connect-timeout 5 "https://api.github.com/repos/thenickdude/KVM-Opencore/releases/latest" | grep OpenCore | grep "\.iso\.gz")"
